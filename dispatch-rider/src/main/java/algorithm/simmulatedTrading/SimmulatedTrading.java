...
public class SimmulatedTrading {
    ...
    public static Map<Integer, Schedule> fullSimmulatedTrading(
        ...
        if (bestHolon == holon)
            return fullSimmulatedTrading(holons, bestHolon, STDepth + 1, info,
                    algorithm, commissionsId, chooseWorstCommission, timestamp);
        return fullSimmulatedTrading(holons, bestHolon, 1, info, algorithm,
     ...
     */
    public static Map<AID, Schedule> fullSimmulatedTrading(Set<AID> aids,
         ...
         */
        if (bestHolon == holon)
            return fullSimmulatedTrading(aids, holons, bestHolon, STDepth + 1,
                    info, commissionsId, chooseWorstCommission, timestamp);
        return fullSimmulatedTrading(aids, holons, bestHolon, 1, info,
                commissionsId, chooseWorstCommission, timestamp);
    }
