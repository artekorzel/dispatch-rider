...
public class GetDriversCreationDataRequestBehaviour extends CyclicBehaviour {

    private static Logger logger = Logger.getLogger(SimulationAgent.class);
    private GUIAgent agent;

    public GetDriversCreationDataRequestBehaviour(GUIAgent agent) {
        this.agent = agent;
    }
